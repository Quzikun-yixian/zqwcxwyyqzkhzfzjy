...
- Simulated vision XY offset: `[-0.0081  0.0122]` m
...
- Wiggle amplitude: `0.003000` m
- Screw turns: `4.000`
- Final XY alignment error: `0.002988` m
- Alignment tolerance: `0.004000` m
- Final insertion depth: `0.025065` m
- Required insertion depth: `0.025000` m
- Hole XY radius from base: `0.514213` m
- Final shaft/tool axis: `[-0.0328 -0.0251 -0.9991]`
- Final tool tilt from world vertical: `2.367` deg
- Max search radius used: `0.011459` m
- CSV log: `peg_in_hole_sweep_wiggle_screw_variant_log.csv`
- Spiral trace image: `peg_in_hole_sweep_wiggle_screw_variant_spiral_trace.svg`

## Spiral Trace

![Archimedes spiral rubbing trace](peg_in_hole_sweep_wiggle_screw_variant_spiral_trace.svg)
