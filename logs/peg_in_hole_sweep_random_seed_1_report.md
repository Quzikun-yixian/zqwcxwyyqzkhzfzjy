...
- Simulated vision XY offset: `[ 0.0136 -0.0044]` m
...
- Final insertion depth: `0.025060` m
- Required insertion depth: `0.025000` m
- Hole XY radius from base: `0.514213` m
- Final shaft/tool axis: `[-0.0438 -0.0338 -0.9985]`
- Final tool tilt from world vertical: `3.169` deg
- Max search radius used: `0.010332` m
- CSV log: `peg_in_hole_sweep_random_seed_1_log.csv`
- Spiral trace image: `peg_in_hole_sweep_random_seed_1_spiral_trace.svg`

## Spiral Trace

![Archimedes spiral rubbing trace](peg_in_hole_sweep_random_seed_1_spiral_trace.svg)
