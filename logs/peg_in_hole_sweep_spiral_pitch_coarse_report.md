...
- Simulated vision XY offset: `[ 0.0064 -0.0168]` m
- Random offset radius limit: `0.020000` m
- Random seed: `5`
- Spiral search radius: `0.030000` m
- Spiral pitch: `0.004000` m/turn
...
- Screw turns: `3.000`
- Final XY alignment error: `0.001994` m
- Alignment tolerance: `0.004000` m
- Final insertion depth: `0.025083` m
- Required insertion depth: `0.025000` m
- Hole XY radius from base: `0.514213` m
- Final shaft/tool axis: `[-0.0333 -0.0256 -0.9991]`
- Final tool tilt from world vertical: `2.408` deg
- Max search radius used: `0.017112` m
- CSV log: `peg_in_hole_sweep_spiral_pitch_coarse_log.csv`
- Spiral trace image: `peg_in_hole_sweep_spiral_pitch_coarse_spiral_trace.svg`

## Spiral Trace

![Archimedes spiral rubbing trace](peg_in_hole_sweep_spiral_pitch_coarse_spiral_trace.svg)
